...
class CardsAnimation {
  static Animation<Alignment> backCardAlignmentAnim(
    ...
    return AlignmentTween(begin: cardsAlign[0], end: cardsAlign[1]).animate(
        CurvedAnimation(
            parent: parent, curve: const Interval(0.4, 0.7, curve: Curves.easeIn)));
  }
  ...
  static Animation<Alignment> middleCardAlignmentAnim(
    ...
    return AlignmentTween(begin: cardsAlign[1], end: cardsAlign[2]).animate(
        CurvedAnimation(
            parent: parent, curve: const Interval(0.2, 0.5, curve: Curves.easeIn)));
  }
    ...
    if (beginAlign.x == -0.001 ||
      ...
      return AlignmentTween(
          ...
          .animate(CurvedAnimation(
              parent: parent, curve: const Interval(0.0, 0.5, curve: Curves.easeIn)));
    } else {
      return AlignmentTween(
              begin: beginAlign,
              end: Alignment(
